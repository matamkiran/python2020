# -*- coding: utf-8 -*-
"""
Created on Sun Feb 28 10:31:41 2021
...
# -*- coding: utf-8 -*-
"""
Created on Sun Feb 28 10:29:27 2021
...
clear = Button(btns_frame, text = "C", fg = "black", width = 20, height = 3, bd = 0, bg = "#eee", cursor = "hand2", command = lambda: btn_clear()).grid(row = 0, column = 0,columnspan=2, padx = 1, pady = 1)
divide = Button(btns_frame, text = "/", fg = "black", width = 10, height = 3, bd = 0, bg = "#eee", cursor = "hand2", command = lambda: btn_click("/")).grid(row = 0, column = 2, padx = 1, pady = 1)
square = Button(btns_frame, text = "S", fg = "black", width = 10, height = 3, bd = 0, bg = "#eee", cursor = "hand2", command = lambda: btn_sqaure()).grid(row = 0, column = 3, padx = 1, pady = 1)
